...
request.setAttribute("year", sdf.format(new java.util.Date()));                  //限定此頁，抓取(前端同樣名字,改為新的字串)
request.setAttribute("tomcatUrl", "https://tomcat.apache.org/");
request.setAttribute("tomcatDocUrl", "/docs/");
request.setAttribute("tomcatExamplesUrl", "/examples/");
request.setAttribute("LAN", "/LAN_test/");
...
<html lang="en">
    ...
    <body>
        <div id="wrapper">
            ...
            <p class="copyright">Copyright &copy; ${year} 藍智.  All Rights Reserved</p>
        </div>
    </body>
